...
- Für Issue `#746` gilt zusätzlich der eigene Safe-Completion-Vertrag: Unter Windows stoppen Live-, Recovery- und Provider-Reconciliation-Pfade vor Credential-, Netzwerk- und Provider-Zugriff. Der read-only Issue-/PR-Abgleich darf keinen GitHub-Gerätecode und keinen Funktion8-/Entra-Browserlogin anfordern oder als nächsten Schritt anbieten. Fehlt ein bereits etablierter Kanal, wird die konkrete Capability-Lücke gemeldet.
