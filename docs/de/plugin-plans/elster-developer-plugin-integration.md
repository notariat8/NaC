...
- optionaler Ausbau zu ERiC, wenn NoC als Hersteller/Entwickler registriert ist
...
2. **Offizielle ERiC-Herstellerintegration**
   ...
   - NoC wird damit zu einer steuerlichen Fachsoftware-Komponente mit hohem Compliance- und Haftungsanspruch
...
- ELSTER- und ERiC-relevante Workflows in NoC modellieren.
...
- keine ELSTER-Passwoerter, PINs, Zertifikatsdateien oder privaten Schluessel in NoC speichern
...
- NoC braucht eine native Runtime-Komponente oder einen isolierten Sidecar, der die ERiC-C-Bibliothek nutzt.
...
- NoC kann Mandanten-Onboarding, Organisationszertifikat-Status, Rollen und Evidence modellieren.
...
- NoC speichert standardmaessig nur Hashes, Metadaten und explizit freigegebene Nachweise.
...
- `elster.prepare_submission` fuer NoC-Prozessanlage
- `elster.record_user_attestation`
- `elster.record_submission_confirmation`
...
- Login-Automation
- Zertifikatsdatei-Upload in NoC
...
- Kundenseitige Entscheidung, welche Inhalte in NoC gespeichert werden.
...
2. Rollen festlegen: NoC als reiner Prozessbegleiter oder als Hersteller/Entwickler mit ERiC.
...
8. ELSTER-Prozessvorlagen in NoC hinterlegen.
...
3. NoC prueft nur Voraussetzungen, keine Geheimnisse.
4. NoC legt Kundentenant und Evidence Store an.
5. NoC aktiviert Prozessvorlagen fuer relevante ELSTER-Verfahren.
6. Kunde fuehrt erste Abgabe weiter im offiziellen ELSTER-Kontext durch.
7. Kunde importiert oder bestaetigt Nachweise.
8. NoC schreibt Audit- und Evidence-Records.
9. Review: Welche Daten duerfen kuenftig automatisiert verarbeitet werden?

## Offene Entscheidungen

- Soll NoC selbst als ELSTER-Hersteller/Entwickler registriert werden?
...
- Welche Kundendaten duerfen in NoC gespeichert werden, welche nur gehasht?
- Ist Mein Unternehmenskonto fuer NoC als Portalbetreiber relevant oder nur als Kundenidentitaetsprozess?
...
- Dokumentinhalte werden standardmaessig nicht in NoC uebertragen.
