...
Dieses Dokument plant die Integration des REINER SCT cyberJack RFID standard als lokales Sicherheits-Plugin fuer NoC. Ziel ist ein belastbarer Einstieg fuer eID-, Kartenleser- und spaeter Signatur-Workflows, ohne dass PIN, Kartenrohdaten oder lokale Geraetekontrolle in die SaaS wandern.
...
5. Challenge vom NoC Identity Service beziehen.
6. eID-Workflow starten.
7. Ergebnis minimiert als Evidence speichern.
8. Evidence in einem NoC-Prozess referenzieren.
