...
Dieses Dokument plant die Integration des REINER SCT cyberJack RFID standard als lokales Sicherheits-Plugin fuer NaC. Ziel ist ein belastbarer Einstieg fuer eID-, Kartenleser- und spaeter Signatur-Workflows, ohne dass PIN, Kartenrohdaten oder lokale Geraetekontrolle in die SaaS wandern.
