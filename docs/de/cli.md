...
nac m365 teams-sharepoint bff-performance-infrastructure-owner-gate --repo-root <repository-root> --expected-activation-hash <64-lowercase-hex> --correlation-id <safe-correlation-id> --monitor-window-anchor-utc <UTC-minute> --toolchain-attestations-json <toolchain-attestations-json-path> --infrastructure-parameters-json <infrastructure-parameters-json-path> --worm-baseline-parameters-json <worm-baseline-parameters-json-path> --format json
...
nac m365 teams-sharepoint bff-azure-activation-interruption-reconcile --expected-activation-hash <64-lowercase-hex> --approval-reference https://github.com/notariat8/NaC/issues/632#issuecomment-<id> --approval-body-sha256 <64-lowercase-hex> --approved-commit <40-lowercase-hex> --approved-tree <40-lowercase-hex> --azure-cli-toolchain-sha256 <64-lowercase-hex> --m365-cli-sha256 <64-lowercase-hex> --m365-node-sha256 <64-lowercase-hex> --build-python-sha256 <64-lowercase-hex> --build-node-sha256 <64-lowercase-hex> --build-npm-cli-sha256 <64-lowercase-hex> --gh-cli-sha256 <64-lowercase-hex> --provisioner-certificate-sha256 <64-lowercase-hex> --provisioner-bootstrap-binding-sha256 <64-lowercase-hex> --reason "<non-empty-owner-reason>" --correlation-id <safe-correlation-id> --reconciler-commit <40-lowercase-hex> --reconciler-tree <40-lowercase-hex> --reconciler-toolchain-sha256 <64-lowercase-hex> --format json
# bff-azure-interruption-terminalization-command
nac m365 teams-sharepoint bff-azure-activation-interruption-reconcile --expected-activation-hash <64-lowercase-hex> --approval-reference https://github.com/notariat8/NaC/issues/632#issuecomment-<id> --approval-body-sha256 <64-lowercase-hex> --approved-commit <40-lowercase-hex> --approved-tree <40-lowercase-hex> --azure-cli-toolchain-sha256 <64-lowercase-hex> --m365-cli-sha256 <64-lowercase-hex> --m365-node-sha256 <64-lowercase-hex> --build-python-sha256 <64-lowercase-hex> --build-node-sha256 <64-lowercase-hex> --build-npm-cli-sha256 <64-lowercase-hex> --gh-cli-sha256 <64-lowercase-hex> --provisioner-certificate-sha256 <64-lowercase-hex> --provisioner-bootstrap-binding-sha256 <64-lowercase-hex> --reason "<non-empty-owner-reason>" --correlation-id <safe-correlation-id> --reconciler-commit <40-lowercase-hex> --reconciler-tree <40-lowercase-hex> --reconciler-toolchain-sha256 <64-lowercase-hex> --confirm-terminalize-and-release --terminalization-action TERMINALIZE_AND_RELEASE_LOCK_ONLY --interrupted-step ensure_resource_group --terminalization-approval-reference https://github.com/notariat8/NaC/issues/717#issuecomment-<id> --terminalization-approval-body-sha256 <64-lowercase-hex> --state-sha256 <64-lowercase-hex> --ledger-head-sha256 <64-lowercase-hex> --target-lock-sha256 <64-lowercase-hex> --legacy-lock-sha256 <64-lowercase-hex> --legacy-host-lock-sha256 <64-lowercase-hex> --provider-observation-sha256 <64-lowercase-hex> --format json
# bff-azure-baseline-interruption-inspection-command
nac m365 teams-sharepoint bff-azure-activation-interruption-reconcile --expected-activation-hash <64-lowercase-hex> --approval-reference https://github.com/notariat8/NaC/issues/632#issuecomment-<id> --approval-body-sha256 <64-lowercase-hex> --approved-commit <40-lowercase-hex> --approved-tree <40-lowercase-hex> --azure-cli-toolchain-sha256 <64-lowercase-hex> --m365-cli-sha256 <64-lowercase-hex> --m365-node-sha256 <64-lowercase-hex> --build-python-sha256 <64-lowercase-hex> --build-node-sha256 <64-lowercase-hex> --build-npm-cli-sha256 <64-lowercase-hex> --gh-cli-sha256 <64-lowercase-hex> --provisioner-certificate-sha256 <64-lowercase-hex> --provisioner-bootstrap-binding-sha256 <64-lowercase-hex> --reason "<non-empty-owner-reason>" --correlation-id <safe-correlation-id> --reconciler-commit <40-lowercase-hex> --reconciler-tree <40-lowercase-hex> --reconciler-toolchain-sha256 <64-lowercase-hex> --format json
# bff-azure-baseline-interruption-terminalization-command
nac m365 teams-sharepoint bff-azure-activation-interruption-reconcile --expected-activation-hash <64-lowercase-hex> --approval-reference https://github.com/notariat8/NaC/issues/632#issuecomment-<id> --approval-body-sha256 <64-lowercase-hex> --approved-commit <40-lowercase-hex> --approved-tree <40-lowercase-hex> --azure-cli-toolchain-sha256 <64-lowercase-hex> --m365-cli-sha256 <64-lowercase-hex> --m365-node-sha256 <64-lowercase-hex> --build-python-sha256 <64-lowercase-hex> --build-node-sha256 <64-lowercase-hex> --build-npm-cli-sha256 <64-lowercase-hex> --gh-cli-sha256 <64-lowercase-hex> --provisioner-certificate-sha256 <64-lowercase-hex> --provisioner-bootstrap-binding-sha256 <64-lowercase-hex> --reason "<non-empty-owner-reason>" --correlation-id <safe-correlation-id> --reconciler-commit <40-lowercase-hex> --reconciler-tree <40-lowercase-hex> --reconciler-toolchain-sha256 <64-lowercase-hex> --confirm-terminalize-and-release --terminalization-action TERMINALIZE_AND_RELEASE_LOCK_ONLY --interrupted-step ensure_resource_group --terminalization-approval-reference https://github.com/notariat8/NaC/issues/719#issuecomment-<id> --terminalization-approval-body-sha256 <64-lowercase-hex> --state-sha256 <64-lowercase-hex> --ledger-head-sha256 <64-lowercase-hex> --target-lock-sha256 <64-lowercase-hex> --legacy-lock-sha256 <64-lowercase-hex> --legacy-host-lock-sha256 <64-lowercase-hex> --provider-observation-sha256 <64-lowercase-hex> --provider-classification BICEP_BASELINE_EXACT --baseline-expectation-sha256 <64-lowercase-hex> --prepared-inputs-manifest-sha256 <64-lowercase-hex> --bicep-snapshot-sha256 <64-lowercase-hex> --bicep-parameters-snapshot-sha256 <64-lowercase-hex> --format json
# bff-azure-function-deployment-inspection-command
...
# bff-azure-function-deployment-release-command
...
`bff-azure-activation-owner-gate` erzeugt daraus offline den exakten kompakten Owner-Kommentar und dessen SHA-256. Der Befehl prüft Commit, Tree und sauberen Worktree vor und nach der Erzeugung, liest keinen Private Key und führt keine Provider-Anfrage aus. Binding-Hashes verwenden kompaktes sortiertes JSON ohne abschließende Newline; der getrennte Toolchain-Gesamthash behält exakt eine Newline. Pretty-JSON, zusätzliche Leerzeichen oder eine Newline am Kommentarende sind nicht freigabegleich und werden vom Live-Verifier abgewiesen. Bei `NOT_READY` wird keine partielle Approval-Payload ausgegeben. Der Pre-Write-Provisioner-Bootstrap verlangt explizite absolute Pfade für State, öffentliches Zertifikat und Private Key, prüft deren Metadaten sowie die exakte Tenant-/App-Bindung und die exakte Sechser-Allowlist der Provisioning-App und liest keinen Private-Key-Inhalt. Seine Readiness ist redigiert und enthält weder IDs noch Credential-Pfade oder -Werte. Der Live-Befehl erstellt aus der aktuellen Prozessumgebung eine lokale Kopie, ergänzt darin ausschließlich das Bootstrap-Overlay und übergibt diese Kopie explizit an die Live-Factory; die globale Prozessumgebung wird nicht verändert. Der State wird atomar über genau einen größenbegrenzten `O_NOFOLLOW`-Deskriptor gelesen. Aus dem State-Hash, den Hashes der drei absoluten Pfade sowie Tenant-, Provisioner-App- und Graph-v1.0-Bindung entsteht der redigierte `provisioner_bootstrap_binding_sha256`. Der Offline-Owner-Gate schreibt ihn in Approval-Payload und `live_cli_arguments`; Live-Aufruf und Recovery müssen exakt denselben Wert mit `--provisioner-bootstrap-binding-sha256` liefern. Roh-State und Pfade werden nicht ausgegeben. Beim Live-Aufruf stoppt ein abweichender Hash mit `PROVISIONER_BOOTSTRAP_BINDING_MISMATCH`; Recovery stoppt bei einer Abweichung mit `FINALIZATION_STATE_INVALID`. Jeder andere Bootstrap-Fehler stoppt mit einem stabilen `PROVISIONER_*`-Fehler, jeweils vor Live-Factory, Providerzugriff und Tenant-Write.

`bff-performance-infrastructure-owner-gate` erzeugt ausschließlich offline den hashgebundenen Owner-Kommentar für die entsperrte WORM-Baseline, die dedizierte Koordinationsinfrastruktur und den vollständigen konservativen Messlauf. Der Befehl misst den sauberen Commit und Tree, die lokalen Toolchain-Attestierungen, beide reproduzierbaren IaC-Pakete, das vollständige Quellpaket der Performance-Capability und -Runtime sowie die drei angegebenen JSON-Eingaben. Die WORM-Baseline bleibt entsperrt; ein irreversibler Policy-Lock ist nicht Teil dieser Freigabe. Der Befehl führt keine HTTP-, DNS-, Azure- oder Graph-Anfrage aus, erstellt oder ändert keine Ressource und startet keinen Messlauf. `READY` bedeutet nur, dass das Freigabeartefakt erzeugt wurde; es ist weder eine Live-Freigabe noch eine Provisioning- oder Ausführungsaktion.

Auf Ubuntu mit aktivem
`kernel.apparmor_restrict_unprivileged_userns=1` ist vor
`bff-azure-activate-live` das gebundene Profil aus
`deploy/runtime/azure/nac-bff/apparmor/nac-azure-cli-sealed-runtime` als
`/etc/apparmor.d/nac-azure-cli-sealed-runtime` zu installieren und zu laden.
Der Live-Befehl wird dann mit
`aa-exec -p nac-azure-cli-sealed-runtime --` gestartet. Ein globales
Deaktivieren der Ubuntu-Userns-Restriktion ist nicht zulässig.

`bff-azure-activation-interruption-reconcile` ist die davon getrennte Kante für einen extern abgebrochenen, noch nicht terminalen Lauf. Issue [#717](https://github.com/notariat8/NaC/issues/717) begrenzt sie zunächst auf exakt Schritt 2 `ensure_resource_group`: Schritt 1 ist `PASSED`, Schritt 2 ist `RUNNING`, spätere Schritte fehlen, die sechs Ledger-Ereignisse bilden eine gültige Hashkette und die Journale `target`, `legacy` und `legacy_host` stehen für denselben Aktivierungs-Hash auf `HELD`. Die Standard-Inspection übergibt die vollständige persistierte #632-Live-Bindung und Reconciler-Bindung, um den alten Lauf zu identifizieren und zu prüfen, ist aber owner-frei: Weder `--owner-approved` noch eine neue #717-Freigabe sind erforderlich. Sie führt zwei identische Azure-Read-Snapshots über `account show`, `provider show`, `group exists`, `group show` und `resource list` aus; das erlaubte Resource-Inventory ist exakt leer. Sie verändert weder lokale Artefakte noch Providerzustand und gibt nur redigierte Bindungs- und Beobachtungshashes mit `MIDRUN_RECONCILIATION_REQUIRED` aus. `Succeeded` für die Ressourcengruppe macht Schritt 2 nicht nachträglich erfolgreich und erlaubt kein Resume. Ungültige beziehungsweise geänderte Beobachtungen liefern die tatsächlichen stabilen Codes `PROVIDER_OBSERVATION_INVALID` und `PROVIDER_OBSERVATION_DRIFT`.

Die alte #632-Live-Freigabe bleibt ausschließlich die Bindung des unterbrochenen Laufs und reicht für die zweite Betriebsart nicht aus. `--confirm-terminalize-and-release` verlangt einen separaten unveränderlichen Owner-Kommentar in Issue #717. Sein kanonischer Body bindet exakt `action`, `activation_hash`, `state_sha256`, `ledger_head_sha256`, `target_lock_sha256`, `legacy_lock_sha256`, `legacy_host_lock_sha256`, `provider_observation_sha256`, `interrupted_step`, `reconciler_commit`, `reconciler_tree`, `reconciler_toolchain_sha256` und `required_owner_login`; die Aktion lautet exakt `TERMINALIZE_AND_RELEASE_LOCK_ONLY`. Nach erneuter Prüfung unter exklusivem `flock` darf der Befehl den alten Lauf ausschließlich zu `FAILED_PARTIAL` terminalisieren, Schritt 2 mit `EXTERNAL_PROCESS_INTERRUPTED_AFTER_WRITE` beenden, `MIDRUN_RELEASE_IN_PROGRESS` schreiben und `RELEASED` append-only an alle drei Journale anhängen. Resume, Rollback, Delete, `PASSED`, Success-Receipt und Provider-Writes bleiben verboten. Ein nicht unterstützter State liefert `INTERRUPTION_RECONCILIATION_UNSUPPORTED`; eine ungültige oder abweichende Freigabe liefert `INTERRUPTION_APPROVAL_INVALID` beziehungsweise `INTERRUPTION_APPROVAL_MISMATCH`; ein gerissener Release liefert `INTERRUPTION_TERMINALIZATION_FAILED` und erlaubt nur einen Retry mit identischer Terminalisierungsbindung. Ein partieller Append darf dabei ausschließlich repariert werden, wenn seine Bytes ein striktes Präfix des deterministisch erwarteten `RELEASED`-Records bilden; nach erneuter Laufzeit-, State-, Pfad- und Descriptor-Prüfung wird nur dieser Tail auf den owner-gebundenen Ausgangszustand zurückgesetzt. Jeder unbekannte Tail blockiert fail-closed.

Vollständiger Terminalisierungsaufruf (die erste Approval-Referenz ist die alte #632-Live-Bindung, die Terminalisierungsreferenz die neue #717-Entscheidung):

```bash
python3 scripts/nac.py m365 teams-sharepoint bff-azure-activation-interruption-reconcile --expected-activation-hash <64-lowercase-hex> --approval-reference <immutable-issue-632-comment-url> --approval-body-sha256 <64-lowercase-hex> --approved-commit <40-lowercase-hex> --approved-tree <40-lowercase-hex> --azure-cli-toolchain-sha256 <64-lowercase-hex> --m365-cli-sha256 <64-lowercase-hex> --m365-node-sha256 <64-lowercase-hex> --build-python-sha256 <64-lowercase-hex> --build-node-sha256 <64-lowercase-hex> --build-npm-cli-sha256 <64-lowercase-hex> --gh-cli-sha256 <64-lowercase-hex> --provisioner-certificate-sha256 <64-lowercase-hex> --provisioner-bootstrap-binding-sha256 <64-lowercase-hex> --reason <non-empty-owner-reason> --correlation-id <safe-correlation-id> --reconciler-commit <40-lowercase-hex> --reconciler-tree <40-lowercase-hex> --reconciler-toolchain-sha256 <64-lowercase-hex> --confirm-terminalize-and-release --terminalization-action TERMINALIZE_AND_RELEASE_LOCK_ONLY --interrupted-step ensure_resource_group --terminalization-approval-reference <immutable-issue-717-comment-url> --terminalization-approval-body-sha256 <64-lowercase-hex> --state-sha256 <64-lowercase-hex> --ledger-head-sha256 <64-lowercase-hex> --target-lock-sha256 <64-lowercase-hex> --legacy-lock-sha256 <64-lowercase-hex> --legacy-host-lock-sha256 <64-lowercase-hex> --provider-observation-sha256 <64-lowercase-hex> --format json
```

Issue [#719](https://github.com/notariat8/NaC/issues/719) ergänzt dazu ausschließlich die getrennte Klassifikation `BICEP_BASELINE_EXACT`; `RESOURCE_GROUP_ONLY` bleibt unverändert Legacy #717. Die Baseline-Erwartung wird aus `prepared/prepared-inputs.redacted.json`, `prepared/main.json` und `prepared/main.parameters.json` abgeleitet und an Aktivierungs-Hash, Commit, Tree sowie Prepared-Manifest-, Template-, Parameter- und Erwartungs-Hash gebunden. Akzeptiert werden exakt sieben Top-Level-Ressourcen: Storage Account, Log Analytics Workspace, App Service Plan, User Assigned Managed Identity, Application Insights Component, Function App und Smart Detection Action Group. Das gebundene ARM-Deployment muss `Succeeded` und `Incremental` sein und nach fail-closed Normalisierung exakt zwölf eindeutige erfolgreiche Deployment-Ziele besitzen. Erfolgreiche ARM-Unteroperationen dürfen ausschließlich dasselbe normalisierte ID-/Typ-Ziel wiederholen; höchstens ein erfolgreicher targetloser `EvaluateDeploymentOutput`-Metadateneintrag ist zulässig. Teilinventar, Zusatzressourcen und ID-, Typ-, Status-, Regions-, Tag-, Managed-Identity-, Deployment-, Operations- oder Snapshot-Drift blockieren fail-closed.

Jeder #719-Snapshot liest Account, Provider, Ressourcengruppe, Inventar, Deployment, Operationen, die User Assigned Managed Identity und die Function-App-Identity-Zuweisung ausschließlich read-only; zusätzlich enumeriert ein exakt gebundener Azure-Resource-Graph-POST die dort sichtbaren Ressourcen und Authorization-Ressourcen im Ziel-Scope. Diese Menge muss exakt aus den sieben Inventarressourcen und zwei Role Assignments bestehen. Die vier von Resource Graph nicht enumerierten Deployment-Child-Ziele bleiben Teil der zwölf zwingenden Einzel-Readbacks. Fehlende oder zusätzliche sichtbare Ressourcen beziehungsweise Role Assignments blockieren mit `AZURE_INTERRUPTION_RESOURCE_GRAPH_INVALID`. Bei allen zwölf direkt gelesenen Ressourcen muss die explizit erlaubte sicherheitsrelevante Property-Projektion exakt dem Bicep-Sollzustand entsprechen; zusätzliche read-only Provider-Metadaten außerhalb dieser Projektion sind zulässig. Das Inventar wird im Snapshot wiederholt und der vollständige Snapshot zweimal bytegleich verlangt. Die Inspection verändert keine lokalen Artefakte und führt keinen Azure- oder Tenant-Write aus. Sie übernimmt keine terminalen CLI-Felder, sondern gibt `provider_classification=BICEP_BASELINE_EXACT`, `baseline_expectation_sha256`, `prepared_inputs_manifest_sha256`, `bicep_snapshot_sha256` und `bicep_parameters_snapshot_sha256` als Teil des kanonischen #719-Owner-Kommentars aus. Der Reconciler liest Commit und Tree mit deaktivierten Git-Replace-Refs und bindet die Laufzeitdateien zusätzlich an die Blob-Digests des genehmigten Trees.
...
Die separate #719-Terminalisierung verlangt die unveränderten Hashwerte aus genau dieser Inspection, einen unveränderlichen Owner-Kommentar in Issue #719 und weiterhin die Aktion `TERMINALIZE_AND_RELEASE_LOCK_ONLY`. Sie beendet Schritt 2 ausschließlich als `FAILED` mit `EXTERNAL_PROCESS_INTERRUPTED_AFTER_WRITE`, setzt den terminalen Laufzustand `FAILED_PARTIAL` und gibt die drei Lock-Journale append-only frei. Resume, Azure-/Tenant-Write, Retry, Rollback, Delete, `PASSED` und Success-Receipt bleiben verboten.

Vollständiger #719-Terminalisierungsaufruf:

```bash
python3 scripts/nac.py m365 teams-sharepoint bff-azure-activation-interruption-reconcile --expected-activation-hash <64-lowercase-hex> --approval-reference <immutable-issue-632-comment-url> --approval-body-sha256 <64-lowercase-hex> --approved-commit <40-lowercase-hex> --approved-tree <40-lowercase-hex> --azure-cli-toolchain-sha256 <64-lowercase-hex> --m365-cli-sha256 <64-lowercase-hex> --m365-node-sha256 <64-lowercase-hex> --build-python-sha256 <64-lowercase-hex> --build-node-sha256 <64-lowercase-hex> --build-npm-cli-sha256 <64-lowercase-hex> --gh-cli-sha256 <64-lowercase-hex> --provisioner-certificate-sha256 <64-lowercase-hex> --provisioner-bootstrap-binding-sha256 <64-lowercase-hex> --reason <non-empty-owner-reason> --correlation-id <safe-correlation-id> --reconciler-commit <40-lowercase-hex> --reconciler-tree <40-lowercase-hex> --reconciler-toolchain-sha256 <64-lowercase-hex> --confirm-terminalize-and-release --terminalization-action TERMINALIZE_AND_RELEASE_LOCK_ONLY --interrupted-step ensure_resource_group --terminalization-approval-reference <immutable-issue-719-comment-url> --terminalization-approval-body-sha256 <64-lowercase-hex> --state-sha256 <64-lowercase-hex> --ledger-head-sha256 <64-lowercase-hex> --target-lock-sha256 <64-lowercase-hex> --legacy-lock-sha256 <64-lowercase-hex> --legacy-host-lock-sha256 <64-lowercase-hex> --provider-observation-sha256 <64-lowercase-hex> --provider-classification BICEP_BASELINE_EXACT --baseline-expectation-sha256 <64-lowercase-hex> --prepared-inputs-manifest-sha256 <64-lowercase-hex> --bicep-snapshot-sha256 <64-lowercase-hex> --bicep-parameters-snapshot-sha256 <64-lowercase-hex> --format json
```

`bff-azure-activation-recovery` ist die einzige Recovery-Kante für einen nach einem Finalisierungsfehler bewusst gehaltenen Lock. Ohne `--confirm-unlock` prüft sie ausschließlich die gebundenen lokalen State-, Ledger-, Evidence- und Marker-Artefakte. Das Entsperren verlangt zusätzlich `--confirm-unlock`, schreibt einen redigierten Reconcile-Marker und führt weder Providerzugriffe noch Resume, Rollback oder automatische Löschungen aus. Lockdateien bleiben als sichere `0600`-Marker dauerhaft bestehen und werden nie automatisch entfernt; `flock` signalisiert den Prozessbesitz, während ein append-only kanonisches JSON-Lines-Journal jeden fsync-gesicherten Übergang `HELD` oder `RELEASED` festhält. Ein unvollständiger letzter Datensatz wird nur bei einem zuvor vollständigen gültigen Datensatz unter gehaltenem `flock` abgeschnitten; eine vorhandene leere oder anderweitig ungültige Journaldatei blockiert fail-closed. Das alte kanonische Einobjektformat mit abschließender Newline bleibt ausschließlich über die gebundene Recovery lesbar und berechtigt nicht zur unbeaufsichtigten Reakquisition. Vor dem Release eines nicht mehrdeutigen terminalen `FAILED_PARTIAL` wird ein hashgebundener `TERMINAL_RELEASE_IN_PROGRESS`-Marker persistiert, sodass ein gerissener Release owner-bound recoverbar bleibt; mehrdeutige Providerzustände behalten weiterhin ihre Quarantäne. Ein verwaister `HELD`-Marker blockiert jeden unbeaufsichtigten Neulauf. Ein partieller `RELEASED`-Übergang bleibt durch den bis zum vollständigen Marker-Readback gehaltenen Recovery-Marker idempotent recoverbar; fehlende Primär- oder Legacy-Marker blockieren fail-closed. Die enge Terminal-Release-Recovery gilt ausschließlich für einen vollständig validierten, nicht mehrdeutigen `FAILED_PARTIAL` mit `TERMINAL_RELEASE_IN_PROGRESS`; andere `FAILED_PARTIAL`-Zustände, ein Crash während eines normalen Write-Schritts ohne diesen Marker oder ein mehrdeutiger ARM-Zustand verlangen zusätzlich provider-spezifische Read-only-Reconciliation und manuelle Owner-Prüfung.
...
## S4b Graph-Write-Edge Dry-Run Offline

`nac m365 teams-sharepoint business-case-type-write-dry-run` prüft die offline implementierte S4b-Write-Edge aus Issue #694 ausschließlich mit synthetischen Eingaben und redigierter Ausgabe. `--operation` akzeptiert exakt `case_create`, `case_status_update`, `task_create`, `task_update` und `business_case_type_backfill`. Der Dry-Run plant Graph REST v1.0, Dedupe beziehungsweise frische ETags, Write und Readback, führt aber keinen Request aus. Credential-, Live-Factory-, HTTP-, DNS-, Graph- und Tenant-Write-Zähler bleiben null; Site-, Listen-, Identitäts- und Feldwerte werden nicht ausgegeben. Der Vertragsrand sieht für einen späteren Write-Pfad eine separate `Sites.Selected`-Identität mit Site-Grant `write` vor, während die BFF-UAMI unverändert `Sites.Selected` mit Site-Grant `read` behält. Produktive Komposition und jeder Live-Write bleiben separat owner-gated.

```bash
nac m365 teams-sharepoint business-case-type-write-dry-run --operation case_create --format json
```

## Offline S4c Graph-Write-Kompositions-Smoke

`nac m365 teams-sharepoint business-case-type-write-composition-smoke` prüft die produktionsnahe lokale Komposition aus Issue #698 mit einer neuen absoluten `--database-path`-SQLite-Datei, injiziertem synthetischem Token-Provider und injiziertem HTTP-Port. Alle fünf S4b-Operationen durchlaufen Plan, persistenten Intent, synthetischen Transport, Outcome und Readback. Der Smoke führt weder Socket-/DNS- noch externe Credential-, Live-Graph- oder Tenant-Zugriffe aus; synthetische Token-Provider-Aufrufe werden separat gezählt. SQLite ist nur für lokale Single-Host-Prozess-Restarts zugesichert. Live-Identität, zentrale Multi-Instance-Durability und jeder Tenant-Write bleiben owner-gated.
...
## Partielle S4f-Produktionsadapter Offline

`nac m365 teams-sharepoint business-case-type-production-adapters` meldet die offline geprüften Adapterimplementierungen aus Issue #704: exakte GitHub-Owner-Kommentarprüfung, zertifikatsbasierte Writer-Erzeugung, redirect-freies Graph REST v1.0 HTTP und lokales SQLite-Evidence-Staging. Die Staging-Outbox ist keine zentrale Wahrheit und darf eine Mutation weder abschließen noch promoten, bestätigen oder bereinigen. PostgreSQL-Promotion/Ack/Retention/lokales Cleanup, Broker, Signatur-Anchor, provider-seitiger Identity-Readback, Azure-WORM-Transport und irreversibler Lock, Runtime-Komposition und Live-Aktivierung bleiben Blocker.
