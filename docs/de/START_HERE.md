...
`README.md` und `docs/de/README.md` sind Projektuebersicht und Index. Dieses
Dokument ist die operative Startsequenz fuer Arbeit im laufenden NoC-Projekt.

`START_HERE.md` bleibt deshalb notwendig, hat aber eine andere Aufgabe als das
README:

| Dokument | Aufgabe |
| --- | --- |
| `README.md` | Repo-Uebersicht, Produktstruktur, Quick Checks, aktuelle Build-Kommandos. |
| `docs/de/README.md` | Deutsche fachliche Orientierung und Dokumentenindex. |
| `docs/de/START_HERE.md` | Verbindlicher Arbeitsstart fuer neue Sitzungen, neue Mitwirkende und Agenten. |
...
1. Repo-Regeln lesen:
   - `AGENTS.md`, sofern im Workspace vorhanden.
...
- Tests unter `tests/`
- Plugin-Artefakte unter `plugins/`
- Workflow-Vertraege unter `workflows/contracts/`
- KG-Artefakte unter `knowledge-graph/`
- Roadmap-/Gantt-Status unter `roadmap/`, `plugins/`, `workflows/` oder
  `usecases/`
...
| Bereich | Zweck |
| --- | --- |
| `plugins/` | Installierbare Plugin-Artefakte fuer GPT Store, Workspace oder lokale Integration. |
...
Jeder Push muss `roadmap/GANTT.md` aktualisieren. Aenderungen unter
`plugins/`, `workflows/` oder `usecases/` muessen zusaetzlich das jeweilige
...
Die Paritaet wird mit `scripts/validate_language_parity.py` geprueft.
