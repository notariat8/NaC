...
**Goal:** NaC erhält einen tenant-aware OCI-Identity-Dry-run-Pfad, und `www-n8` führt ohne Mandatsdaten in diesen SaaS-Pfad.

**Architecture:** Eine neue NaC-Domänenschicht berechnet Domain-Readiness und OCI-Admin-Provisioning-Pläne deterministisch. CLI und Web-API nutzen dieselbe Logik. `www-n8` bleibt statisch und verlinkt Bestands- und Neukunden in die NaC-App.

**Tech Stack:** Python Standard Library, `unittest`, NaC CLI, NaC lokaler Webserver, GitHub Project, statisches HTML/CSS/JS für `www-n8`.

---

### Task 1: Vertrags- und Dokumentationsgrenze
...
### Task 4: CLI, Web-API und Quality Gate
...
### Task 5: www-n8 Tenant-Aware Übergang
