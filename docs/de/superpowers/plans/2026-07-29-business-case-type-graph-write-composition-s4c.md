...
- [ ] **WP1 – Verträge:** S4c-Domain- und Verification-Contract, Validator und
  Spec-Traceability für `AC-S4C-01` bis `AC-S4C-08`.
- [ ] **WP2 – State:** SQLite-Adapter mit atomarem State-/Event-Commit,
  vollständiger Übergangsmatrix, Zwei-Verbindungs-CAS,
  Authorization-Run-Bindung und lokalem POSIX-Prozess-Restart-Envelop.
- [ ] **WP3 – Transport:** Graph-v1.0-Adapter mit injiziertem Token- und
  HTTP-Port, Redirect-/Host-/Methoden-/Body-Grenzen und ohne Auto-Retry.
- [ ] **WP4 – Komposition:** reine DI-Wurzel ohne Env-/Credential-/Live-Factory.
- [ ] **WP5 – Offline-Smoke:** temporärer State und Fake-HTTP für alle fünf
  ...
  separat ausgewiesen.
- [ ] **WP6 – Crash-/Negativtests:** Restart-Fenster, Korruption, CAS-Konflikte,
  Busy/Timeout, Blockaden vor Transport ohne Token-Provider-Aufruf und
  Providerfehler ohne Rohdaten.
- [ ] **WP7 – Doku/Context:** DE/EN-CLI, Architektur, Contract-Indizes,
  Agent-Context und Roadmap synchronisieren.
- [ ] **WP8 – Abschluss:** Fokustests, Validator, Contracts, Compileall,
