...
Status: Plan freigegeben; Offline-Builder-Reparatur in Draft-PR, kein Paketkandidat, Treiber-Release oder Real-Read freigegeben
...
Der Verification Contract setzt `repository_external_release_candidate` für die
aktuelle Reparatur ausdrücklich auf `false`. Ein späterer Paketkandidat
erfordert eine eigene Freigabe und eine vorwärtsgerichtete Vertragsänderung.
