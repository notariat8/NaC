...
4. Einen Blob-REST-Lease-Adapter für einen vorab angelegten, ETag-gebundenen Blob mit Acquire, Assert und Release implementieren (`AC-733-04`).
...
6. Messpolitik, Monitor, Lease, einmaligen Blob-Bootstrap, Runner-Identität, RBAC/ABAC, Infrastrukturplan und -parameter, Commit, Tree und Toolchain in genau einem kombinierten Owner-Gate hashbinden; ETag und konkrete Lease-Bindung per Readback nachweisen (`AC-733-05`, `AC-733-08`).
