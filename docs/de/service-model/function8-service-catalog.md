# Function8 Service Catalog fuer NaC

## Ziel

Dieses Dokument listet alle Function8-Leistungen im Kontext `NaC` transparent und oeffentlich nachvollziehbar.
...
| f8-nac-governance-pack | Governance und Policy Pack | documentation_and_controls | no | governance_metadata | `policies/process-policy.yaml`, `policies/role-model-policy.yaml`, `policies/access-control-policy.yaml` | `docs/de/governance.md`, `docs/de/issues/operations.md` | vollstaendig repo-basiert, durch Dritte uebernehmbar |
