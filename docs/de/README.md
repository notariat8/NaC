...
- [BusinessCaseType Graph Write Composition S4c](superpowers/specs/2026-07-29-business-case-type-graph-write-composition-s4c-design.md) implementiert Issue #698 offline: lokale SQLite-Generation-CAS-/Evidence-State, injizierter Graph-REST-v1.0-Transport und synthetischer Token-Port komponieren alle fünf S4b-Operationen mit Crash-/Restart-Blockade; Live-Graph und Tenant-Writes bleiben null.
- [BusinessCaseType Live-Write-Grenze S4d](superpowers/specs/2026-07-29-business-case-type-live-write-boundary-s4d-design.md) komponiert Issue #700 offline: hashgebundene Owner-Attestation, getrennte Write-/BFF-Identitäten, lokale SQLite-Replay-Sicherung sowie vollständige S6/S6b-Publikation vor lokaler Closure; Live-Adapter und Tenant-Writes bleiben owner-gated.
