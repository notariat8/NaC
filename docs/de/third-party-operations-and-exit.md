...
- Servicekatalog: `docs/de/function8-service-catalog.md`
- Tenant-Modell: `docs/de/tenant-ownership-and-eventlock-service.md`
- Revisionssicherheitskonzept: `docs/de/revisionssicherheit-eventstreaming.md`
