...
- optionaler Ausbau zu ERiC, wenn OaC8 als Hersteller/Entwickler registriert ist
...
2. **Offizielle ERiC-Herstellerintegration**
   ...
   - OaC8 wird damit zu einer steuerlichen Fachsoftware-Komponente mit hohem Compliance- und Haftungsanspruch
...
- ELSTER- und ERiC-relevante Workflows in OaC8 modellieren.
...
- keine ELSTER-Passwoerter, PINs, Zertifikatsdateien oder privaten Schluessel in OaC8 speichern
...
- OaC8 braucht eine native Runtime-Komponente oder einen isolierten Sidecar, der die ERiC-C-Bibliothek nutzt.
...
- OaC8 kann Mandanten-Onboarding, Organisationszertifikat-Status, Rollen und Evidence modellieren.
...
- OaC speichert standardmaessig nur Hashes, Metadaten und explizit freigegebene Nachweise.
...
- `elster.prepare_submission` fuer OaC-Prozessanlage
- `elster.record_user_attestation`
- `elster.record_submission_confirmation`
...
- Login-Automation
- Zertifikatsdatei-Upload in OaC
...
- Kundenseitige Entscheidung, welche Inhalte in OaC gespeichert werden.
...
2. Rollen festlegen: OaC8 als reiner Prozessbegleiter oder als Hersteller/Entwickler mit ERiC.
...
8. ELSTER-Prozessvorlagen in OaC hinterlegen.
...
3. OaC prueft nur Voraussetzungen, keine Geheimnisse.
4. OaC legt Kundentenant und Evidence Store an.
5. OaC aktiviert Prozessvorlagen fuer relevante ELSTER-Verfahren.
6. Kunde fuehrt erste Abgabe weiter im offiziellen ELSTER-Kontext durch.
7. Kunde importiert oder bestaetigt Nachweise.
8. OaC schreibt Audit- und Evidence-Records.
9. Review: Welche Daten duerfen kuenftig automatisiert verarbeitet werden?

## Offene Entscheidungen

- Soll OaC8 selbst als ELSTER-Hersteller/Entwickler registriert werden?
...
- Welche Kundendaten duerfen in OaC gespeichert werden, welche nur gehasht?
- Ist Mein Unternehmenskonto fuer OaC8 als Portalbetreiber relevant oder nur als Kundenidentitaetsprozess?
...
- Dokumentinhalte werden standardmaessig nicht in OaC uebertragen.
