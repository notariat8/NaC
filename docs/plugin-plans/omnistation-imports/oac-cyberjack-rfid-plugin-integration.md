...
User Workstation
  ...
  oac8-cyberjack-local-plugin
        ...
        v
OaC8 SaaS / OCI
  oac8-identity-service
  tenant evidence store
  audit log
  OaC process request / pull request
```
...
- Kartenrohdaten an OaC8 oder ein LLM geben,
...
Das Plugin sollte als lokaler MCP- oder HTTP-Adapter startbar sein. MCP ist fuer OaC/Codex ergonomisch; HTTP ist fuer Desktop- und Browser-Integrationen einfacher testbar. Beide Varianten koennen denselben Kern nutzen.
...
10. Produktive Freigabe im OaC-Prozess dokumentieren.
...
- Attributfreigabe komplett ausserhalb OaC8 oder mit minimiertem Attributsatz?
