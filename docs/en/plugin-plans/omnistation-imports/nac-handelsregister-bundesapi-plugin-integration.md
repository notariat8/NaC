...
- German source artifact:
  [docs/de/plugin-plans/omnistation-imports/nac-handelsregister-bundesapi-plugin-integration.md](../../../de/plugin-plans/omnistation-imports/nac-handelsregister-bundesapi-plugin-integration.md)
- Active English plan:
