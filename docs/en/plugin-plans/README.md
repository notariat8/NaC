...
| [bnotk-xnp-notariatssoftware.md](bnotk-xnp-notariatssoftware.md) | `NaC XNP-Pruefung` local companion | `NaC Karte/SAK`, workstation and interface check | Local plan/apply companion | Local logs, evidence, update maintenance |
...
| [cyberjack-rfid-plugin-integration.md](cyberjack-rfid-plugin-integration.md) | `NaC Karte/SAK` before XNP login | Card, reader, PC/SC, SAK lite, secureFramework | Card/SAK readiness for XNP test | Firmware, driver, card path, evidence |
