...
| [bnotk-xnp-notariatssoftware.md](bnotk-xnp-notariatssoftware.md) | `NoC XNP-Pruefung` local companion | `NoC Karte/SAK`, workstation and interface check | Local plan/apply companion | Local logs, evidence, update maintenance |
...
| [cyberjack-rfid-plugin-integration.md](cyberjack-rfid-plugin-integration.md) | `NoC Karte/SAK` before XNP login | Card, reader, PC/SC, SAK lite, secureFramework | Card/SAK readiness for XNP test | Firmware, driver, card path, evidence |
