...
| Workflow-Verträge | `workflows/contracts/` | Aktiv | Eingaben, Ausgaben, Freigaben, Datenklassen, Plugin-Abhängigkeiten sowie KG-Editor-, BPMN-js-Editor-, GNotKG-Kosten-, lokaler Webpreview-, Secure-Document-Link-, Legal-Research-Connector-Kandidaten-, Legal-Graph-, Kommentar-Connector-, NaC-On-Prem-Agent-Runtime-, On-Prem-Connector-Grenz- und Mandatsdaten-Redaktionsvertrag. Kommentar-, On-Prem-Connector- und Mandatsdaten-Verträge bleiben vor produktivem Zugriff durch Lizenzbasis-, AVV-/DPA-, Berufsgeheimnis-, AI-SBOM-, Sicherheitsgrenzen-, Credential-, Testmodus-, Privacy-, Speicher- und Owner-Gates blockiert. |
