...
| Workflow-Verträge | `workflows/contracts/` | Aktiv | Eingaben, Ausgaben, Freigaben, Datenklassen, Plugin-Abhängigkeiten sowie KG-Editor-, BPMN-js-Editor-, GNotKG-Kosten-, lokaler Webpreview-, Secure-Document-Link-, Legal-Research-Connector-Kandidaten-, Legal-Graph-, Legal-Source-Inventar-Lizenz-TDM-, Legal-Nemotron-Readiness-, Legal-Model-Evaluationsbenchmark-, Kommentar-Connector-, NaC-On-Prem-Agent-Runtime-, Ponytail-Agent-Tooling-Kandidaten-, Ponytail-Skill-Only-Smoke-, On-Prem-Connector-Grenz-, Mandatsdaten-Redaktions-, privater Betriebsrahmen-Gate-, Private-Payload-Ziel- und Zugriffsmatrixvertrag. Kommentar-, Legal-Nemotron-, Legal-Source-Inventar-, Legal-Model-Benchmark-, Ponytail-Agent-Tooling-, Ponytail-Skill-Only-Smoke-, On-Prem-Connector-, Mandatsdaten- und Private-Payload-Verträge bleiben vor produktivem Zugriff durch Lizenzbasis-, TDM-, AVV-/DPA-, Berufsgeheimnis-, AI-SBOM-, Sicherheitsgrenzen-, Credential-, Hook-, Runtime-Aktivierungs-, Testmodus-, Privacy-, Benchmark-, Holdout-, Evaluation-, Model-Card-, Rollen-, Zweck-, Speicher-, Retention-, Verschlüsselungs- und Owner-Gates blockiert. |
