...
notarielle Einreichungsablaeufe zuerst mit `nac-bnotk-xnp` beginnen. Dieses
...
- Erfordert die `nac-bnotk-xnp`-Pruefung vor XNotar-/Registeruebergabe-Arbeit.
...
- Fuer notariatsseitigen Arbeitsablauf zuerst `nac-bnotk-xnp`-Bereitschaft bestaetigen.
...
- abgeschlossene `nac-bnotk-xnp`-Bereitschaft fuer notarielle Arbeitsablaeufe
