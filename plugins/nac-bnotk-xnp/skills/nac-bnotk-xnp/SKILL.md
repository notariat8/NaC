---
name: nac-bnotk-xnp
description: Nach nac-cyberjack-rfid nutzen, wenn Online-HRA, Handelsregister, XNotar oder Notariatssoftware XNP-Authentifizierungsbereitschaft, Amtstaetigkeitskontext, API-Key-Vorhandensein ohne Werte oder Nachweisplaene braucht.
---
...
2. Abgeschlossene `nac-cyberjack-rfid`-Karten-/SAK-Readiness bestaetigen oder den
