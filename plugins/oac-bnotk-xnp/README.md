...
- Requires completed `oac-cyberjack-rfid` card/SAK readiness before XNP login testing.
...
- Confirm `oac-cyberjack-rfid` readiness for card, security-class-3 reader, SAK lite/XNP card path and secureFramework.
...
- Completed `oac-cyberjack-rfid` card/SAK readiness
