...
class NaCHardwareBridgeTests(unittest.TestCase):
    ...
    def test_operator_copy_is_usecase_first_workbench(self) -> None:
        ...
        self.assertIn('class="demo-boundary"', html)
        self.assertIn("Demo-Grenze", html)
        self.assertIn("synthetische Testdaten", html)
        self.assertIn("keine echten Mandatsdaten", html)
        self.assertIn("keine Ausweise", html)
        self.assertIn("keine Zugangsdaten", html)
        self.assertIn("keine PINs", html)
        self.assertIn("keine produktiven XNP-", html)
        self.assertIn("Register-", html)
        self.assertIn("Grundbuchaktionen", html)
        ...
        self.assertIn('data-matter-count', html)
        self.assertIn('data-open-panel="matters"', html)
        ...
        self.assertIn("Notariats-Workflow", js)
        self.assertIn("CLI-Musterakte", js)
        self.assertIn("Änderung vorschlagen", js)
        self.assertIn("Nächster Schritt", js)
        self.assertIn("· ${escapeHtml(nextStepContext)}", js)
        ...
        matter_card_actions = css.split(".matter-card-actions {", maxsplit=1)[1].split("}", maxsplit=1)[0]
        self.assertIn("align-items: flex-start;", matter_card_actions)
        self.assertIn("min-width: 16rem;", matter_card_actions)
