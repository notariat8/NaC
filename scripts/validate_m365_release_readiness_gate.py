...
REQUIRED_DOC_MARKERS: dict[str, tuple[str, ...]] = {
    ...
    "docs/de/operations/release-checklist.md": (
        ...
        "`5/5` erkannten Negativfällen",
        "missing_reason",
        "expired_delegation",
        "workspace_scope_violation",
        "audit_readback_missing",
        "Fail-Closed-Grenze vor Graph-Writes",
    ),
    "docs/en/operations/release-checklist.md": (
        ...
        "workspace_scope_violation",
        "audit_readback_missing",
        "fail-closed boundary before Graph writes",
    ),
    "docs/de/cli.md": (
...
REQUIRED_BATCH_APPROVAL_MARKERS: dict[str, tuple[str, ...]] = {
    "src/nac_cli/cli.py": (
        ...
        "_m365_release_gate_run_post_run_report_index_command",
        "_list_m365_release_gate_post_run_reports",
        "_write_m365_release_gate_post_run_report_index_artifact",
        "release_gate_write_post_run_report",
        ...
        "_render_m365_release_gate_policy_review_markdown",
        "_m365_release_gate_policy_review_summary",
        "_m365_matter_access_retention_upgrade_plan",
        "_write_m365_matter_access_retention_upgrade_plan_artifact",
        "matter_access_apply_policy_review_status",
        "matter_access_retention_upgrade_plan_status",
        "matter_access_retention_upgrade_command_count",
        "verification.m365_matter_access_delegation",
        "missing_reason",
    ...
    "tests/test_m365_release_gate_runner.py": (
        ...
        "test_release_gate_post_run_report_surfaces_current_matter_access_upgrade_plan",
        ...
        "test_release_gate_post_run_report_index_artifact_writes_redacted_files",
        "matter_access_apply_policy_review_status",
        "matter_access_retention_upgrade_plan_status",
        "matter_access_retention_upgrade_command_count",
        "verification.m365_matter_access_delegation",
        "Negative cases detected: `5/5`",
        "release-gate-post-run-report",
        "release-gate-post-run-report-index",
    ),
}
...
REQUIRED_QUALITY_GATE_MARKERS = (
    ...
    "workspace_scope_violation",
    "audit_readback_missing",
    "fail-closed before Graph writes",
)
...
REQUIRED_REPORT_SURFACE_MARKERS: dict[str, tuple[str, ...]] = {
    ...
    "docs/en/quality-gate.md": (
        ...
        "workspace_scope_violation",
        "audit_readback_missing",
        "fail-closed boundary before Graph",
    ),
}
