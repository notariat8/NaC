...
def validate_domain_contract(contract: dict[str, Any]) -> list[str]:
    ...
    exact_sections = {
        "graphTransport": {
            ...
            "encodedPathSeparatorsAllowed": False,
        ...
        "ownerVerification": {
            ...
            "binaryExecutionExact": "sha256_verified_sealed_memfd",
            "stdoutCaptureBoundedBeforeCompletion": True,
        ...
        "writeIdentity": {
            ...
            "certificateContentSha256BindingRequired": True,
            "privateKeyContentSha256BindingRequired": True,
            "credentialFilesReopenedByProvider": False,
