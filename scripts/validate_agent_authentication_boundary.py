...
REQUIRED_AGENT_MARKERS = (
    ...
    "Jede Funktion8-/Microsoft-Anmeldeanforderung muss ausdrücklich `ofunk@funktion8` oder `funktion8@funktion8` als gewünschten Benutzer nennen",
...
EXPECTED_POLICY = {
    ...
    "function8_login_account_choices": ["ofunk@funktion8", "funktion8@funktion8"],
