        ...
        checks.extend(
            [
                ...
                (
                    ...
                    "Notarial Ontology Storage Contract",
                    [sys.executable, "scripts/validate_notarial_ontology_storage_contract.py"],
                ),
                (
                    "notarial_process_ontology_contract",
                    "Notarial Process Ontology Contract",
                    [sys.executable, "scripts/validate_notarial_process_ontology_contract.py"],
                ),
                (
                    "business_case_type_runtime",
                    "Business Case Type Runtime",
                    [sys.executable, "scripts/validate_business_case_type_runtime.py"],
                ),
                (
                    "business_case_type_graph_read_edge",
                    "Business Case Type Graph Read Edge",
                    [sys.executable, "scripts/validate_business_case_type_graph_read_edge.py"],
                ),
                (
                    "business_case_type_graph_write_edge",
                    "Business Case Type Graph Write Edge",
                    [sys.executable, "scripts/validate_business_case_type_graph_write_edge.py"],
                ),
                (
                    "business_case_type_graph_write_composition",
                ...
                (
                    "business_case_type_live_write_boundary",
                    "Business Case Type Live Write Boundary",
                    [
                        sys.executable,
                ...
                (
                    "business_case_type_live_write_readiness",
                ...
                (
                    "business_case_type_production_adapters",
                    "Business Case Type Production Adapters S4f",
                    [
                        sys.executable,
                ...
                (
                    "business_case_type_azure_blob_worm_s6b",
                    "Business Case Type Azure Blob WORM S6b",
                    [sys.executable, "scripts/validate_business_case_type_azure_blob_worm.py"],
                ),
                (
                ...
                (
                    ...
                    "Process Ontology SharePoint Schema Apply Readiness",
                    [sys.executable, "scripts/validate_process_ontology_sharepoint_schema_apply_readiness.py"],
                ),
                (
                    "process_ontology_sharepoint_schema_apply_execution_contract",
                    "Process Ontology SharePoint Schema Apply Execution Contract",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_execution_contract.py",
                    ],
                ),
                (
                    "process_ontology_sharepoint_schema_apply_runner_dry_run",
                    "Process Ontology SharePoint Schema Apply Runner Dry Run",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_runner_dry_run.py",
                    ],
                ),
                (
                ...
                (
                    "process_ontology_sharepoint_schema_apply_artifact_index",
                    "Process Ontology SharePoint Schema Apply Artifact Index",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_artifact_index.py",
                    ],
                ),
                (
                    "process_ontology_sharepoint_schema_apply_live_readiness_gate",
                    "Process Ontology SharePoint Schema Apply Live Readiness Gate",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_live_readiness_gate.py",
                    ],
                ),
                (
                    "process_ontology_sharepoint_schema_apply_owner_gated_live_plan",
                    "Process Ontology SharePoint Schema Apply Owner-Gated Live Plan",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_owner_gated_live_plan.py",
                    ],
                ),
                (
                    "process_ontology_sharepoint_schema_apply_owner_gated_runner_contract",
                    "Process Ontology SharePoint Schema Apply Owner-Gated Runner Contract",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_owner_gated_runner_contract.py",
                    ],
                ),
                (
                    "process_ontology_sharepoint_schema_apply_live_runner",
                    "Process Ontology SharePoint Schema Apply Live Runner",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_live_runner.py",
                    ],
                ),
                (
                    "process_ontology_sharepoint_schema_apply_graph_dispatcher",
                    "Process Ontology SharePoint Schema Apply Graph Dispatcher",
                    [
                        sys.executable,
                        "scripts/validate_process_ontology_sharepoint_schema_apply_graph_dispatcher.py",
                    ],
                ),
                (
                ...
                (
                    ...
                    "Notarial Deep Process Candidate Routing",
                ...
                (
                    "first_wave_bpmn_outline_gap_review",
                    "First Wave BPMN Outline Gap Review",
                ...
                (
                    "first_wave_process_deep_model",
                    "First Wave Process Deep Model",
                    [sys.executable, "scripts/validate_first_wave_process_deep_model.py"],
                ),
                (
                ...
                (
                    ...
                    "M365 Azure BFF Live Activation Contract",
                ...
                (
                    "m365_matter_access_apply_live_smoke_retention",
