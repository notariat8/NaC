...
Vereinsregisteranmeldungen fuer Vorstandswechsel, Satzungsaenderungen, Gruendung oder Aufloesung mit oeffentlicher Beglaubigung, Beschluessen und Anlagen.
...
| --- | --- | --- | --- |
| `association.identity` | Verein Identitaet | Notariatsfachkraft | register_review |
| `filing.type` | Einreichung Art | Notariat | drafting |
| `board.identity` | Vorstand Identitaet | Notariatsfachkraft | identity_gate, certification |
