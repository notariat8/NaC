...
| D | Produktkommunikation, Adoption und externe Bewertung | Aktiv | 37% | Root-README führt jetzt mit Nutzen, Grenzen, Owner-Sichtbarkeit, vier Zielgruppenpfaden plus Maintainer-Pfad und sichtbarer Attribution; separate Startseiten erklären Notariatsentscheidung, Betrieb, Integration sowie Prüfung und Standardisierung; Reifegrad, Glossar, CLI-first-Ausführungsmodell, präzisierte Gantt-Regel, AGPL-/CC-BY-Lizenzmodell, ein durchgehender Immobilienkaufvertrag-Pfad, ein repo-lokaler Codex-Logo-Assetbestand und ein sichtbares BPMN-Menü in der Operator-Webapp machen den Stand für Nicht-Technik-Leser greifbarer. |
