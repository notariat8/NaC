...
gantt
    ...
    BusinessCaseType-S3-Offline-Runtime         :active,  b1ai, 2026-07-11, 7d
    BusinessCaseType-S4-Graph-Adapter           :         b1aj, after b1ai, 7d
    ...
    Legal-Source-Inventar-Prüftiefe              :done,    b1zch, 2026-06-30, 1d
    ...
    AI-SBOM-Baseline-Export-Mapping              :done,    b1zg, 2026-06-30, 1d
...
Identitäts-Roadmap-Hinweis 2026-07-06: Für den MVP ist
`https://app.notariat8.de/login` der kanonische Kundeneinstieg. Entra ID,
Microsoft-365-Gruppen, Teams und SharePoint sind die finale Startspur; OCI
Identity Domains und ATP sind als Legacy-Alternative archiviert und keine
aktive Planungsannahme mehr. Spätere Kunden-IdP-Föderation bleibt ein Zielbild
und braucht separate Design-, Sicherheits-, AVV-/DPA-, Rollen- und
Owner-Apply-Gates.
